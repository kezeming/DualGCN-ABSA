...
# * DualGCN
CUDA_VISIBLE_DEVICES=0 python ./DualGCN/train.py --model_name dualgcn --dataset laptop --seed 1000 --num_epoch 1 --vocab_dir ./DualGCN/dataset/Laptops_corenlp --cuda 1 --losstype doubleloss --alpha 0.2 --beta 0.2 --parseadj
# * DualGCN with Bert
